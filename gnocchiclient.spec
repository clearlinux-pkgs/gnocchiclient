...
%prep
%setup -q -n gnocchiclient-7.0.7
cd %{_builddir}/gnocchiclient-7.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598021462
...
cp %{_builddir}/gnocchiclient-7.0.7/LICENSE %{buildroot}/usr/share/package-licenses/gnocchiclient/294b43b2cec9919063be1a3b49e8722648424779
